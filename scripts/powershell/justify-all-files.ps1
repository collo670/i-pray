# Script to justify text in all mwaka2* and mwaka3* HTML files

# Function to add text justification to an HTML file
function Add-TextJustification {
    param (
...
foreach ($file in $mwaka2Files) {
    Add-TextJustification -FilePath $file.FullName
}
